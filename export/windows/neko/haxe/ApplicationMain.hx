...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "Project Disco", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Project Disco";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Project Disco", null, { width: 640, height: 480 });
